...
public class Practice05ComposeShaderView extends View {
...

    {
        ...
        Shader shader1 =  new BitmapShader(batmanBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
        Shader shader2 =  new BitmapShader(batManLogoBitmap, Shader.TileMode.CLAMP, Shader.TileMode.CLAMP);
